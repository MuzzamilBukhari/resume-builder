...
(_a = document
    ...
    if (profilePictureInput &&
        ...
        experienceElement &&
        skillsElement) {
        var fullName_1 = fullNameElement.value;
        ...
        var resumeHTML = "\n<h2>Resume</h2>\n".concat(profilePictureURL
            ...
            : "", "\n<p><strong>FullName:").concat(fullName_1, "</p>\n<p><strong>Email:").concat(email, "</p>\n<p><strong>Age:</strong>").concat(age, "</p>\n<p><strong>Address:").concat(address, "</p>\n<p><strong>Phone Number:</strong>").concat(phoneNumber, "</p>\n\n<h3>Education:</h3>\n<p>").concat(education, "</p>\n\n<h3>Experience:</h3>\n<p>").concat(experience, "</p>\n\n<h3>Skills:</h3>\n<p>").concat(skills, "</p>\n");
        // resume output
            ...
            shareableLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://http://127.0.0.1:5500/resume/".concat(fullName_1.replace(/\s+/g, "_"), "_cv.html");
